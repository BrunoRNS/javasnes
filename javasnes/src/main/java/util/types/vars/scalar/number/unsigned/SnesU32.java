...
public class SnesU32 extends SnesScalarUnsignedNumber {
    ...
    /**
     * Constructs a SnesU32 with the specified name, type, and global flag.
     *
     * @param name   the name of the unsigned int of 32 bits
    ...
    public SnesU32(
        ...
        try {
            ...
            throw new IllegalArgumentException(
                "Invalid argument sent to SnesU32 class: " + e.getMessage()
            );
    ...
    /**
     * Constructs a SnesU32 with the specified name, global flag, and default value.
     *
     * @param name         the name of the unsigned int of 32 bits
     * @param global       whether the number is global
    ...
    /**
     * Validates the fields of this SnesU32 instance.
     * <ul>
