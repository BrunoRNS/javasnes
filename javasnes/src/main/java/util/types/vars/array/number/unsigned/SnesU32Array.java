...
/**
 * Class representing an array of SNES unsigned 32-bit numbers.
 */
public class SnesU32Array extends SnesArrayUnsignedNumber {
     ...
     */
    public SnesU32Array(String name, short length) {
     ...
     */
    public SnesU32Array(String name, short length, String defaultValue) {
     ...
     */
    public SnesU32Array(String name, Short[] length, byte dimensions) {
     ...
     * @param defaultValue the default value of the array
     */
    public SnesU32Array(String name, Short[] length, byte dimensions, String defaultValue) {
