...
/**
 * Class representing an array of SNES unsigned 8-bit numbers.
 */
public class SnesU8Array extends SnesArrayUnsignedNumber {
     ...
     */
    public SnesU8Array(String name, short length) {
     ...
     */
    public SnesU8Array(String name, short length, String defaultValue) {
     ...
     */
    public SnesU8Array(String name, Short[] length, byte dimensions) {
     ...
     * @param defaultValue the default value of the array
     */
    public SnesU8Array(String name, Short[] length, byte dimensions, String defaultValue) {
